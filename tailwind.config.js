            ...
            colors: {
                ...
                theme: {
                    ...
                    status: {
                        ...
                        owned: 'rgb(var(--color-status-owned) / <alpha-value>)',
                        'owned-bg': 'rgb(var(--color-status-owned-bg) / <alpha-value>)',
                        ...
                        wishlist: 'rgb(var(--color-status-wishlist) / <alpha-value>)',
                        'wishlist-bg': 'rgb(var(--color-status-wishlist-bg) / <alpha-value>)',
                        'for-trade': 'rgb(var(--color-status-for-trade) / <alpha-value>)',
                        'for-trade-bg': 'rgb(var(--color-status-for-trade-bg) / <alpha-value>)',
                        'previously-owned': 'rgb(var(--color-status-previously-owned) / <alpha-value>)',
                        'previously-owned-bg': 'rgb(var(--color-status-previously-owned-bg) / <alpha-value>)',
                    },
                    star: {
