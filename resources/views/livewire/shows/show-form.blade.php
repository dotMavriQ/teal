    ...
    <main class="py-10">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <form wire:submit="save" class="space-y-8">
                    ...
                    <div class="px-4 py-6 sm:p-8">
                        <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-4">
                                ...
                                <div class="mt-2">
                                    <input wire:model="original_title" type="text" id="original_title" class="block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2">
                                    <input wire:model="imdb_id" type="text" id="imdb_id" placeholder="tt1234567" class="block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
                            </div>
                ...
                <div class="bg-theme-card-bg shadow-sm ring-1 ring-theme-border-primary sm:rounded-xl">
                    <div class="px-4 py-6 sm:p-8">
                        <h2 class="text-base font-semibold leading-7 text-theme-text-primary">Show Details</h2>
                        <p class="mt-1 text-sm leading-6 text-theme-text-secondary">Optional information about the show.</p>
                        ...
                        <div class="mt-6 grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input wire:model="genres" type="text" id="genres" placeholder="Drama, Thriller, Sci-Fi" class="block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
                ...
                <div class="bg-theme-card-bg shadow-sm ring-1 ring-theme-border-primary sm:rounded-xl">
                    <div class="px-4 py-6 sm:p-8">
                        ...
                        <p class="mt-1 text-sm leading-6 text-theme-text-secondary">Track when you watched this show.</p>

                        <div class="mt-6 grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            {{-- Date Added --}}
                            <div class="sm:col-span-3">
                                <label for="date_added" class="block text-sm font-medium leading-6 text-theme-text-primary">Date Added</label>
                                <div class="mt-2">
                                    <input wire:model="date_added" type="text" id="date_added" placeholder="DD/MM/YYYY" class="block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
                                @error('date_added') <p class="mt-2 text-sm text-theme-danger">{{ $message }}</p> @enderror
                            </div>
                ...
                <div class="flex items-center justify-end gap-x-6">
                    <a href="{{ $isEditing && $show ? route('shows.show', $show) : route('shows.index') }}" class="text-sm font-semibold leading-6 text-theme-text-primary">
                        Cancel
                    </a>
