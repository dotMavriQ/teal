            ...
            <div class="lg:grid lg:grid-cols-3 lg:gap-x-8">
                    ...
                    @if(count($game->platform ?? []) > 0)
                        <div class="mt-4 flex flex-wrap gap-3">
                            @foreach($game->platform as $platform)
                                ...
                                >
                                    @if($meta['logo'])
                                        <span class="inline-block h-7 w-14 shrink-0
                ...
                <div class="mt-10 lg:col-span-2 lg:mt-0">
                    ...
                    <div class="mt-6 flex flex-wrap items-center gap-4">
                        ...
                        <div class="flex items-center gap-1" role="group" aria-label="Rating">
                            @for($i = 1; $i <= 10; $i++)
                                <button
                                    ...
                                    type="button"
                                    class="h-8 w-8 rounded-md text-sm font-bold transition-colors focus:outline-hidden focus:ring-2 focus:ring-theme-accent-primary {{ $i <= ($game->rating ?? 0) ? 'bg-theme-star-filled text-theme-text-inverted' : 'bg-theme-bg-tertiary text-theme-text-secondary hover:bg-theme-bg-hover' }}"
                        ...
                        {{-- Edit & Delete --}}
                        <a href="{{ route('games.edit', $game) }}" class="btn-secondary inline-flex items-center rounded-md px-3 py-2 text-sm font-semibold shadow-xs ring-1 ring-inset ring-theme-border-primary hover:bg-theme-bg-hover">
                            Edit
                        </a>
                        <button
