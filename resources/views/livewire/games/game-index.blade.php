                    ...
                    <div class="flex flex-1 flex-col gap-3 sm:flex-row sm:items-center">
                        ...
                        >
                            ...
                            <optgroup label="Your Data">
                                ...
                                @if(in_array($status, ['playing', 'played', '']))
                                    <option value="date_started">Date Started</option>
                                @endif
                                @if(in_array($status, ['played', '']))
                                            ...
                                            <div class="mt-1 flex items-center gap-1 flex-wrap">
                                                ...
                                                @if($game->platform)
                                                    @foreach(array_slice($game->platform ?? [], 0, 1) as $plat)
                                                        <span class="inline-flex items-center rounded px-1.5 py-0.5 text-[10px] font-medium bg-theme-bg-tertiary text-theme-text-muted border border-theme-border-primary">{{ $plat }}</span>
                                                    @endforeach
                                                @endif
                                            </div>
                                        </div>
                                                    ...
                                                    @if($game->platform)
                                                        <div class="flex flex-wrap gap-1">
                                                            @foreach(array_slice($game->platform ?? [], 0, 2) as $plat)
                                                                <span class="inline-flex items-center rounded px-1.5 py-0.5 text-xs font-medium bg-theme-bg-tertiary text-theme-text-muted border border-theme-border-primary">{{ $plat }}</span>
                                                            @endforeach
                                                        </div>
                                                    @else
