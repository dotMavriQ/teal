...
<nav x-data="{ open: false }" class="bg-theme-bg-primary border-b border-theme-border-primary">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-dropdown align="left" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('listening.index')" wire:navigate>
                                    {{ __('All Listening') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('concerts.index')" wire:navigate>
                                    {{ __('Live') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('albums.index')" wire:navigate>
                                    {{ __('Collection') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-3 pb-1 border-t border-theme-border-primary">
            ...
            <div class="mt-1 space-y-0.5">
                <x-responsive-nav-link :href="route('listening.index')" :active="request()->routeIs('listening.index')" wire:navigate>
                    {{ __('All Listening') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('concerts.index')" :active="request()->routeIs('concerts.*')" wire:navigate>
                    {{ __('Live') }}
                </x-responsive-nav-link>
