    ...
    <main class="py-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if($watchingStats['total_movies'] > 0)
                <div class="mb-8">
                    <h2 class="text-lg font-medium text-theme-text-primary mb-4">Watching Stats</h2>
                    <dl class="grid grid-cols-1 gap-5 sm:grid-cols-3">
                        <div class="overflow-hidden rounded-lg bg-theme-card-bg px-4 py-5 shadow-sm ring-1 ring-theme-border-primary sm:p-6">
                            <dt class="truncate text-sm font-medium text-theme-text-secondary">Currently Watching</dt>
                            <dd class="mt-1 text-3xl font-semibold tracking-tight text-theme-status-watching">
                                {{ $watchingStats['currently_watching'] }}
                            </dd>
                        </div>
                        <div class="overflow-hidden rounded-lg bg-theme-card-bg px-4 py-5 shadow-sm ring-1 ring-theme-border-primary sm:p-6">
                            <dt class="truncate text-sm font-medium text-theme-text-secondary">Watched This Year</dt>
                            <dd class="mt-1 text-3xl font-semibold tracking-tight text-theme-status-watched">
                                {{ $watchingStats['watched_this_year'] }}
                            </dd>
                        </div>
                        <div class="overflow-hidden rounded-lg bg-theme-card-bg px-4 py-5 shadow-sm ring-1 ring-theme-border-primary sm:p-6">
                            <dt class="truncate text-sm font-medium text-theme-text-secondary">Total Movies</dt>
                            <dd class="mt-1 text-3xl font-semibold tracking-tight text-theme-accent-primary">
                                {{ $watchingStats['total_movies'] }}
                            </dd>
                        </div>
                    </dl>
                </div>
