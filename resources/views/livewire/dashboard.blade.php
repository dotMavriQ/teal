                    ...
                    @if($category['active'])
                        ...
                        >
                            ...
                            @if($category['name'] === 'Watching' && ($watchingStats['total_movies'] > 0 || $animeStats['total_anime'] > 0))
                                <div class="mt-3 flex gap-3 text-xs text-theme-text-secondary">
                            ...
                            @elseif($category['name'] === 'Reading' && $readingStats['total_books'] > 0)
                                <div class="mt-3 text-xs text-theme-text-secondary">
