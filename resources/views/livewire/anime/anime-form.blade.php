                    ...
                    <div class="px-4 py-6 sm:p-8">
                        <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-4">
                                ...
                                <div class="mt-2">
                                    <input wire:model="original_title" type="text" id="original_title" placeholder="Japanese title" class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2">
                                    <input wire:model="year" type="number" id="year" min="1900" max="2100" class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2">
                                    <select wire:model="media_type" id="media_type" class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                        <option value="">—</option>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2">
                                    <input wire:model="mal_id" type="number" id="mal_id" class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
                            </div>
                    ...
                    <div class="px-4 py-6 sm:p-8">
                        ...
                        <div class="mt-6 grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2">
                                    <input wire:model="episodes_total" type="number" id="episodes_total" min="0" class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2">
                                    <input wire:model="episodes_watched" type="number" id="episodes_watched" min="0" class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2">
                                    <input wire:model="runtime_minutes" type="number" id="runtime_minutes" min="1" class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input wire:model="genres" type="text" id="genres" placeholder="Action, Comedy, Fantasy" class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input wire:model="studios" type="text" id="studios" placeholder="MAPPA, Bones" class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
                                <p class="mt-1 text-xs text-theme-text-muted">Comma-separated</p>
                            </div>
                            ...
                            <div class="sm:col-span-6">
                                ...
                                <div class="mt-2">
                                    <input wire:model="poster_url" type="url" id="poster_url" placeholder="https://..." class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
