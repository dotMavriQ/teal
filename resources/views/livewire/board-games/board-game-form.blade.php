                        ...
                        <div class="mt-6 grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-6">
                                ...
                                <div class="mt-2 flex gap-2">
                                    <input wire:model="genreInput" type="text" id="genreInput" placeholder="e.g. Strategy, Worker Placement" wire:keydown.enter.prevent="addGenre" class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input wire:model="designer" type="text" id="designer" class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2">
                                    <input wire:model="year_published" type="number" id="year_published" min="1900" max="2099" placeholder="e.g. 2023" class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2">
                                    <input wire:model="min_players" type="number" id="min_players" min="1" class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2">
                                    <input wire:model="max_players" type="number" id="max_players" min="1" class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input wire:model="playing_time" type="number" id="playing_time" min="0" class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
                    ...
                    <div class="px-4 py-6 sm:p-8">
                        ...
                        <div class="mt-6 grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input wire:model="plays" type="number" id="plays" min="0" class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
                    ...
                    <div class="px-4 py-6 sm:p-8">
                        ...
                        <div class="mt-6 grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input wire:model="bgg_id" type="number" id="bgg_id" class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
