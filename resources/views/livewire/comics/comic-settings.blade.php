                ...
                <div class="px-4 py-5 sm:p-6">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            <div class="shrink-0 p-3 {{ $apiConfigured ? 'bg-emerald-100' : 'bg-red-100' }} rounded-lg">
                ...
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="mt-6">
                        <button
                            ...
                            type="button"
                            class="inline-flex items-center rounded-md bg-theme-danger px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-theme-danger/80"
                        >
