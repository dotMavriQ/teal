                    ...
                    <div class="px-4 py-6 sm:p-8">
                        ...
                        <div class="mt-6 grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-4">
                                ...
                                <div class="mt-2">
                                    <input wire:model="artist" type="text" id="artist" class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input wire:model="genre" type="text" id="genre" placeholder="Rock, Electronic, Jazz" class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input wire:model="styles" type="text" id="styles" placeholder="Shoegaze, Dream Pop" class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
                                <p class="mt-1 text-xs text-theme-text-muted">Comma-separated</p>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input wire:model="format" type="text" id="format" placeholder="e.g. Vinyl, CD, Cassette" class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input wire:model="label" type="text" id="label" placeholder="e.g. Sub Pop" class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input wire:model="country" type="text" id="country" placeholder="e.g. US" class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
                    ...
                    <div class="px-4 py-6 sm:p-8">
                        ...
                        <div class="mt-6 grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-6">
                                ...
                                <div class="mt-2">
                                    <textarea wire:model="notes" id="notes" rows="4" placeholder="Your thoughts about this album..." class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6"></textarea>
                                </div>
                    ...
                    <div class="px-4 py-6 sm:p-8">
                        ...
                        <div class="mt-6 grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input wire:model="discogs_id" type="number" id="discogs_id" class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input wire:model="discogs_master_id" type="number" id="discogs_master_id" class="block w-full rounded-md border-0 py-1.5 shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-accent-primary sm:text-sm sm:leading-6">
                                </div>
