                ...
                <div class="px-4 py-5 sm:p-6">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            <div class="flex-shrink-0 p-3 bg-theme-status-watchlist-bg rounded-lg">
                        ...
                        <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                            ...
                            <div class="mt-2">
                                ...
                                <p class="mt-3 text-sm text-theme-text-primary">
                                    Please type <code class="rounded bg-theme-bg-tertiary px-2 py-1 font-mono text-red-600 font-semibold" x-text="confirmWord"></code> to confirm.
                                </p>
                                <div class="mt-3">
                                    <input
                                        x-model="userInput"
                                        type="text"
                                        class="block w-full rounded-md border-0 py-1.5 text-theme-text-primary bg-theme-bg-secondary shadow-sm ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-red-600 sm:text-sm sm:leading-6 font-mono"
