<div>
                ...
                <ol role="list" class="flex items-center space-x-4">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-4 text-sm font-medium text-gray-500" aria-current="page">Settings</span>
                        </div>
                    </li>
                </ol>
            </nav>
    ...
    <main class="py-10">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <a href="{{ route('books.metadata') }}" class="block bg-white shadow rounded-lg hover:shadow-md transition-shadow">
                <div class="px-4 py-5 sm:p-6">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h2 class="text-lg font-medium text-gray-900">Metadata Enrichment</h2>
                                <p class="mt-1 text-sm text-gray-500">Fetch missing book metadata from OpenLibrary</p>
                            </div>
                        </div>
            ...
            <div class="bg-white shadow rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    <h2 class="text-lg font-medium leading-6 text-gray-900">Cover Management</h2>
                    <p class="mt-1 text-sm text-gray-500">Book covers are cached locally for faster loading.</p>
                    ...
                    <div class="mt-6">
                        ...
                        <p class="mt-2 text-xs text-gray-500">Downloads fresh covers from OpenLibrary and stores them locally.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white shadow rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Irreversible actions.</p>
