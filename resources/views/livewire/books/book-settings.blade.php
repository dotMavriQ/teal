<div>
    ...
    <main class="py-10">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <a href="{{ route('books.metadata') }}" class="block bg-theme-card-bg shadow-sm rounded-lg hover:shadow-md transition-shadow">
                ...
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="mt-6">
                        <button
                            ...
                            type="button"
                            class="inline-flex items-center rounded-md bg-theme-accent-primary px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-theme-accent-primary/80 disabled:opacity-50"
                        >
                            ...
                            <div class="mt-2">
                                ...
                                <div class="mt-3">
                                    <input
                                        x-model="userInput"
                                        type="text"
                                        class="block w-full rounded-md border-0 py-1.5 text-theme-text-primary shadow-xs ring-1 ring-inset ring-theme-border-primary placeholder:text-theme-text-muted focus:ring-2 focus:ring-inset focus:ring-theme-danger sm:text-sm sm:leading-6 font-mono"
